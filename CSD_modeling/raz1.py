...
plt.rc('font', size=6)
left, right, bottom, top = 0.10, 0.86, 0.05, 0.99
...
for i in range(len(targets)):
    ...
    if (i == 4):
        ax.set_xlabel('radius  ($^{\prime\prime}$)', labelpad=2)
...
# colorbar
cbax = fig.add_axes([right + 0.02, bottom, 0.025, 0.375])
